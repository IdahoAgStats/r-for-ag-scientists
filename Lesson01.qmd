...
- tools for debugging code (removing errors). We will not use this in the workshop! But you can learn more about it [here](https://support.posit.co/hc/en-us/articles/205612627-Debugging-with-the-RStudio-IDE). 
...
- more utility functions. You can check for RStudio updates here, access community help forum, and othern forms of documentation in addition to standard help files. 

### more

Rstudio has a massive number of keyboard shortcuts. You can find them in the menu and summarized in this [cheatsheet](https://github.com/rstudio/cheatsheets/blob/master/rstudio-ide.pdf)