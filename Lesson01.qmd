...
Rstudio has a massive number of keyboard shortcuts. You can find them in the menu (Help --> Cheat Sheets) and summarized in this [cheat
sheet](https://github.com/rstudio/cheatsheets/blob/master/rstudio-ide.pdf)
