...
(@) Import "weather_data.csv". Group the data by station and year and count the number of missing data points for 'tmax', 'tmin' and 'tavg'. This one is pretty hard, so it's okay to start with the next problem, which is a .  
