...
(@) Here is a crazy extra exercise that utilizes transpose instead of pivoting. It's not strictly related to reshaping. Only try this if you're in the mood for a challenge. 
