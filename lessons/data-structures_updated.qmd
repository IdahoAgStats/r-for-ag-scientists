...
Previously, we looked at a dataset. Now we need to consider how those data sets are arranged into complex structures (that is, objects) we can access and manipulate.
...
In this lesson, we will mainly cover vector and data.frame. We encourage attendants to go over the reading material for matrix and list provided in this lesson.
