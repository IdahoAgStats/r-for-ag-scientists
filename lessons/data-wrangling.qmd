...
(@) Import "trial_metadata.csv" with the [***readr***](https://readr.tidyverse.org/) function `read_csv()`. 
...
(@) Import "weather.csv" with the [***readr***](https://readr.tidyverse.org/) function `read_csv()`. Filter the weather data set for when the station is "USC00456215"
