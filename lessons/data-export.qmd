...
::: {.callout-tip title="Practice Test" collapse="true"}
## Practice test
...
2. Examine the output files to make sure they look as expected? Where any row names accidentally introduced? Were missing cells converted to "NA"? Did any data become unexpectedly quoted? 
