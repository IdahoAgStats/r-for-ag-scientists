...
- At the end of each class, review the learning goals and decide if you met those goals. These are designed to be the bare minimum of knowwledge to competently use R. Later workshop/course content builds on this knowledge.  
...
- If some material is not clear, re-run the code from class and reread the notes here; watch the videos. 
