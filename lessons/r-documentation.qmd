...
2 options for installing packages on [CRAN](https://cran.r-project.org/web/packages/available_packages_by_name.html) (Comprehensive R Archive Network).
...
#### Option 2: The RStutio 'Packages' window:
