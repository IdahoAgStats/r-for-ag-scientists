...
You can check this with `getwd()`. You can set the file path relative to the current working directory or set an absolute path. If this sounds unfamiliar, that is okay.
