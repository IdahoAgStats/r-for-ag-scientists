...
This is a normal function call (the function being `rownames_to_column()`), and it is specifying that the package where this function resides is [tibble](https://tibble.tidyverse.org/reference/tibble-package.html) (a tibble is the Tidyverse alternative to the data farme). 
